...
function randomEmail() {
  return (
    random(FALLBACK_EMAIL_NAMES) +
    "@" +
    random(FALLBACK_EMAIL_DOMAINS) +
    random(FALLBACK_EMAIL_EXTENSIONS)
  );
}

function randomPassword() {
  return (
    random(FALLBACK_PASSWORD_WORDS) +
    random(FALLBACK_PASSWORD_NUMBERS) +
    random(FALLBACK_PASSWORD_SYMBOLS)
  );
}

function randomUsername() {
  return (
    random(FALLBACK_USERNAME_NAMES) + "_" + random(FALLBACK_USERNAME_NUMBERS)
  );
}
...
function randomPhone() {
  return (
    "+1 " +
    random(FALLBACK_PHONE_AREA) +
    "-" +
    random(FALLBACK_PHONE_MID) +
    "-" +
    random(FALLBACK_PHONE_LAST)
  );
}
